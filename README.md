...
## Login behavior
The login page does not ask users to select Admin/User.
Supabase authentication identifies the account, and the employee profile's `role`
in PostgreSQL determines its permissions. The user only selects which page to open:
Attendance Dashboard or Employee Data.
